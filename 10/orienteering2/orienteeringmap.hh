...
#include <iomanip>
#include <set>
#include "point_info.hh"

// uusi luokka johon tallennetaan pisteiden tiedot.
/*
struct PointInfo
{
    std::string name_;
...
private:
    ...
    std::map< std::string, Point_info > points;
    std::map< std::string, std::vector<std::string> > routes_map;
